...
- **證據層級總覽（GRADE，本次審閱加註）**
- PD vs extracorporeal 存活/恢復/感染無差異（Liu 2017 Cochrane, 6 RCT n=484）→ **LOW**（受試族群/處方異質、多數試驗 open-label、單一研究權重高、imprecision 顯著）
- HV-TPD 優於 CKRT（Al-Hwiesh 2018 n=125）→ **LOW**（單中心、open-label、CKRT 組可能未依 KDIGO 劑量、效果量大但未被他組重現）
- HVPD weekly Kt/V 3.5 vs 更高劑量無額外獲益（Gabriel 2008 n=120 RCT）→ **MODERATE**（單中心但劑量對比明確、mortality 為硬 endpoint）
- Bicarbonate vs lactate buffer（Bai 2010 n=20 pilot RCT）→ **VERY LOW**（極小樣本、無 mortality power、surrogate endpoint）
- **KDIGO 2024 劑量指引更新（本次審閱加註）**：Daugirdas 引用 ISPD 2020 的 weekly Kt/V 3.5 上限；**KDIGO 2024 Practice Point 5.3.3** 建議 **weekly Kt/V 2.2（18–24 L PD fluid/day）優於更高劑量**，臨床實務取低標即可。
- **台灣適用性（本次審閱加註）**：台灣成人 AKI 幾乎由 CRRT/IHD 主導，PD for AKI 於成人極罕見；兒科與心臟術後新生兒仍有少數中心採用（TSN AKI 共識 2020 建議 A5-4-3b）。詳見文末「台灣臨床情境」段落。
